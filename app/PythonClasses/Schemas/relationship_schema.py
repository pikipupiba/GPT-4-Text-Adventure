    ...
    "Relationship_Schema":{
        ...
        "items":{
            ...
            "properties":{
                "type":{
                    "type":"string",
                    "description":"Type of relationship. Be creative, precise, and concise. The type should logically follow from the player's actions.",
                    "examples":[
                ...
                "change":{
                    "type":"integer",
                    "description":"change in the number of relationships of this type based on the change rationale"
                },
                "count":{
                    "type":"integer",
                    "description":"previous number of relationships of this type +/- change"
                },
            }
        }
    }
