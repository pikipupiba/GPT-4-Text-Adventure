...
from PythonClasses.Game.ChatMessage import ChatMessage, DisplayType, RoleType
...
class History:
    ...
    def last_system_message(self) -> Optional[ChatMessage]:
        return next((message for message in reversed(self.messages) if message.role == RoleType.SYSTEM), None)
